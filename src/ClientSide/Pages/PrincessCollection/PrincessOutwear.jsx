...
const PrincessOutwear = () => {
    const [princessOutwearCollections, setPrincessOutwearCollections] = useState([]);

    const princessOutwearCollectionsProducts = "/Womens/womenOutwear.json";

    useEffect(() => {
        // Fetch the JSON data
        fetch(princessOutwearCollectionsProducts)
            .then(response => {
                if (!response.ok) {
            ...
            .then(data => {
                setPrincessOutwearCollections(data);
                console.log(data);
            })
            .catch(error => {
                console.error('Fetch error:', error);
            });
    }, [princessOutwearCollectionsProducts]);
