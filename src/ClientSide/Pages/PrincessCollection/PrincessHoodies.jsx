...
const PrincessHoodies = () => {
    const [princessHoodiesCollections, setPrincessHoodiesCollections] = useState([]);

    const princessHoodiesCollectionsProducts = "/Womens/womenHoodies.json";

    useEffect(() => {
        // Fetch the JSON data
        fetch(princessHoodiesCollectionsProducts)
            .then(response => {
                if (!response.ok) {
            ...
            .then(data => {
                setPrincessHoodiesCollections(data);
                console.log(data);
            })
            .catch(error => {
                console.error('Fetch error:', error);
            });
    }, [princessHoodiesCollectionsProducts]);
