...
const PrincessPants = () => {
    const [princessPantsCollections, setPrincessPantsCollections] = useState([]);

    const princessPantsCollectionsProducts = "/Womens/womenPants.json";

    useEffect(() => {
        // Fetch the JSON data
        fetch(princessPantsCollectionsProducts)
            .then(response => {
                if (!response.ok) {
            ...
            .then(data => {
                setPrincessPantsCollections(data);
                console.log(data);
            })
            .catch(error => {
                console.error('Fetch error:', error);
            });
    }, [princessPantsCollectionsProducts]);
