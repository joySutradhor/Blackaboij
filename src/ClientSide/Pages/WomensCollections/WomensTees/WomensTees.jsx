...
const WomensTees = () => {
    ...
    const [womenTeesCollections, setWomenTeesCollections] = useState([]);
    const womenTeesCollectionsProducts = "/Womens/womenTees.json";

    useEffect(() => {
        // Fetch the JSON data
        fetch(womenTeesCollectionsProducts)
            .then(response => {
                if (!response.ok) {
            ...
            .then(data => {
                setWomenTeesCollections(data);
            })
            .catch(error => {
                console.error('Fetch error:', error);
            });
    }, [womenTeesCollectionsProducts]);
    ...
    return (
        <div>
            ...
            <div className="grid md:grid-cols-3 grid-cols-2 gap-[10px] md:gap-[25px] md:mt-[25px] md:mx-[50px] mx-[20px]">
                {womenTeesCollections.map((product) => (
