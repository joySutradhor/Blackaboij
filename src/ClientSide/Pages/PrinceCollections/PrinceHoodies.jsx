...
const PrinceHoodies = () => {
    const [princeHoodiessCollections, setPrinceHoodiesCollections] = useState([]);

    const princeHoodiesCollectionsProducts = "/hoodiesAndSweeters.json";
