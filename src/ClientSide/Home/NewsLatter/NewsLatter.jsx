...
const NewsLatter = () => {
    return (
        <div className=" md:h-[300px]  mb-5 md:mb-[50px] bg-slate-200 flex flex-col justify-center items-center " >
            ...
            <div className="flex md:flex-row flex-col gap-4 md:py-8 py-4">
                <input type="email" placeholder="Email Address" className="border border-[#b1b1b1]  pl-2 bg-transparent focus:outline-none text-gray-600 w-[250px] "></input>
